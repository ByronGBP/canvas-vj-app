...
var Fireworks = function () {
    ...
    self.init = function () {
        ...
        self.canvas = document.getElementById("fire-canvas");
        ...
        self.ctx.canvas.height = self.ch;
        self.ctx.canvas.width = self.cw;
